...
# 1) Салмақталған қиылысу жиіліктері

def weighted_intersection(list1, list2, k):
    # Әр тізімдегі элементтердің жиілігі
    freq1 = {}
    freq2 = {}
    ...
    # Екі тізімдегі барлық бірегей элементтер
...
# 2. Арифметикалық прогрессияны тексеру
...
def is_arithmetic_progression(head):
    # Тізім элементтерін массивке жинау
    arr = []
    curr = head
    ...
    # Барлық келесі элементтерді тексеру
